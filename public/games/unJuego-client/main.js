window.game = (function(){
	...
	return {
		...
		stop: function(){
			sendMessage({key: 'finish', name: user.realname});
		},
		onMessage: function(msg){
			...
			case 'waiting':
				...
				break;
			case 'init':
				ball1.color = ball2.color = "rgba(255, 255, 255, 0.4)";
				if(msg.ball1.player == user.realname) {
					myball = msg.ball1;
					ball1.color = "#FFFFFF";
				} else {
					myball = msg.ball2;
			...
			case 'update':
				...
				break;
			case 'winner':
				window.game.finished = true;
				if(msg.winner == user.email){
					message.text = 'Congrats! You are the winner!';
				}else{
