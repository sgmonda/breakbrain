...
\begin{figure}[h]
  \begin{center}
    ...
    \caption{Minijuegos ({\tt http://www.minijuegos.com})}
  \end{center}
\end{figure}
...
\begin{figure}[h]
  \begin{center}
    ...
    \caption{Categorías de juegos en Minijuegos ({\tt http://www.minijuegos.com})}
...
\begin{figure}[h]
  \begin{center}
    ...
    \caption{Miniclip ({\tt http://www.miniclip.com})}
    \label{fig::miniclip}
  \end{center}
\end{figure}
